...
public class Scene_tableauDeBordSuperAdmin extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        MenuItem déconnexionMenuItem = new MenuItem("Déconnexion");
        ...
        connexionMenu.getItems().addAll(déconnexionMenuItem, quitterItem);
        ...
        déconnexionMenuItem.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                Stage stage  = new Stage();
